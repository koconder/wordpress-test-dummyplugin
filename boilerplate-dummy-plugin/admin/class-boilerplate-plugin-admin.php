...
class boilerplate_plugin_Admin
{
     ...
     *
     * @since 1.0.0
     * @param string $boilerplate_plugin The name of this plugin.
    ...
    public function enqueue_styles() 
    {
        ...
        wp_enqueue_style($this->boilerplate_plugin, plugin_dir_url(__FILE__) . 'css/boilerplate-plugin-admin.css', array(), $this->version, 'all');
    ...
    public function enqueue_scripts() 
    {
        ...
        wp_enqueue_script($this->boilerplate_plugin, plugin_dir_url(__FILE__) . 'js/boilerplate-plugin-admin.js', array( 'jquery' ), $this->version, false);
